...
<body>
        ...
        <table style="margin-bottom: 0;">
            <tr>
                <td width="50%">
                    ...
                    @if ($logoMedia)
                        <img src="{{ $logoMedia->getPath() }}" height="40" style="margin-bottom: 10px;">
                    @else
                        <img src="{{ public_path('/sakiko.jpeg') }}" height="40" style="margin-bottom: 10px;">
                    @endif
                ...
                <td width="50%" class="text-right">
                    <div style="font-size: 12px; font-weight: 700; color: #0f172a; margin-bottom: 8px;">PAYSLIP
                        #{{ substr($data['uuid'], 0, 8) }}</div>
                    <div style="margin-bottom: 8px;"><span
                            class="badge badge-success">{{ $data['status']['label'] }}</span></div>
        ...
        <tr>
            <td width="50%">
                ...
                <table class="data-table">
                    <tr>
                        <td>Nama</td>
                        <td class="bold">: {{ $data['employee']['name'] }}</td>
                    </tr>
                    <tr>
                        <td>NIK</td>
                    ...
                    <tr>
                        <td>Status Kerja</td>
                        <td>: {{ $data['employee']['employment_status'] }}</td>
                    </tr>
                </table>
            </td>
            <td width="50%">
        ...
        <tr>
            ...
            <td>
                ...
                <table class="data-table">
                    ...
                    <tr>
                        <td>Early Leave</td>
                        <td class="text-right">{{ number_format($data['deductions']['early_leave_deduction'], 0) }}
                        </td>
                    </tr>
                    <tr>
    ...
    <div class="net-salary-box">
        <table>
            <tr class="bold">
                <td width="60%"
                    style="font-size: 12px; color: #64748b; text-transform: uppercase; letter-spacing: 1px;">Take Home
                    Pay</td>
